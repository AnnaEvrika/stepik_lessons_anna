...
class BasePageLocators(GeneralLocators):
    ...
    icon_signout = (By.CSS_SELECTOR, ".icon-signout")
...
class ProductPageLocators:
    ...
    link_computers_in_literature = (
    By.PARTIAL_LINK_TEXT, "/catalogue/category/books/fiction/computers-in-literature_4/")
    link_non_fiction = (By.PARTIAL_LINK_TEXT, "/catalogue/category/books/non-fiction_5/")
    link_essential_programming = (
    By.PARTIAL_LINK_TEXT, "b/catalogue/category/books/non-fiction/essential-programming_6/")
